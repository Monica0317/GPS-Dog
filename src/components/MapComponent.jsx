    ...
    <div>
      <div className="mb-3">
        <button
          ...
          className={`btn ${isTracking ? "btn-danger" : "btn-success"}`} // Corrección en la clase del botón
        >
      ...
      {position && (
        <div style={{ height: "700px", width: "100%" }} className="border rounded">
          <MapContainer
            ...
            whenCreated={setMap} // Reemplaza ref por whenCreated para evitar advertencias
          >
            <TileLayer
